...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  return (
    <motion.div 
      className="flex flex-col items-center justify-center text-center p-8 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-dashed border-slate-300 dark:border-slate-700 h-full min-h-[200px]"
    ...
    >
      ...
      <h3 className="text-lg font-medium text-slate-800 dark:text-slate-200 mb-2">{title}</h3>
      <p className="text-slate-500 dark:text-slate-400 mb-4 max-w-md">{description}</p>
