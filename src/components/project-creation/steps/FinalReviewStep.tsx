                ...
                <div>
                  ...
                  <div className="mt-2 space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm font-medium text-slate-900 dark:text-slate-200">{data.complexity}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-slate-600 dark:text-slate-400">Language</span>
                      <span className="text-sm font-medium text-slate-900 dark:text-slate-200">{data.language}</span>
                    </div>
                  </div>
                </div>
