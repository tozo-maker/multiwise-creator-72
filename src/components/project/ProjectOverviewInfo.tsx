  ...
  return (
    <Card className="md:col-span-2 bg-slate-800 border-slate-700">
      <CardHeader className="pb-2">
        <CardTitle className="text-xl text-slate-100">Project Overview</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <span className="text-sm font-medium text-slate-300">{project.progress}% Complete</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-4 gap-y-2 text-sm pt-2">
            ...
            <div className="text-slate-400 font-medium">Last modified</div>
            <div className="text-slate-200">{project.lastModified}</div>
            
            <div className="text-slate-400 font-medium">Owner</div>
            <div className="text-slate-200">{project.owner}</div>
          </div>
        </div>
      </CardContent>
    </Card>
